...
- Planning and impact analysis are not generated by agent workflows yet; the UI
  shows evidence-derived outlines until Phase 16 adds benchmarked generation.
